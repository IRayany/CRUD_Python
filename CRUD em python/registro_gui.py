...
class RegistroGUI:
    def __init__(self, parent):
        ...
        tree = ttk.Treeview(frame, columns=("Raça", "Nome", "Peso", "Data da Consulta", "Próxima Consulta"), height=10, show="headings")  
        ...
        for col in ("Raça", "Nome", "Peso", "Data da Consulta", "Próxima Consulta"):
